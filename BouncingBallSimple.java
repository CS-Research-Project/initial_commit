...
// Extends JPanel, so as to override the paintComponent() for custom rendering codes. 
   ...
   // Container box's width and height
      ...
      int MONITOR_WIDTH = dim.width;
      int MONITOR_HEIGHT = dim.height;
      private final int BOX_WIDTH = MONITOR_WIDTH;
      private final int BOX_HEIGHT = MONITOR_HEIGHT;
   
   // Ball's properties
      private float ballRadius = 100; // Ball's radius
      private float ballX = ballRadius + 50; // Ball's center (x, y)
      private float ballY = ballRadius + 20; 
      private float ballSpeedX = 100;   // Ball's speed for x and y
